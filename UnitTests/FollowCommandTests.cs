...
namespace UnitTests
{
    ...
    public class FollowCommandTests
    {
        ...
        public void Setup()
        {
            ...
            _command = new List<ICommand>() { new FollowCommand(_mockTwitterUserFeedService.Object, _mockParseCommand.Object) };
            _commandFactory = new CommandFactory(_command);
        }

        [Test]
        [ExpectedException(typeof(ArgumentException))]
        public void ExecuteFollowCommand_When_Data_IsNull()
        {
            //Arrange
        ...
        [Test]
        public void ExecuteFollowCommand_When_Passing_InValid_Wall_Command_Returns_False()
        {
            //Arrange
        ...
        public void ExecutePostCommand_When_Passing_Valid_Post_Command_Returns_True()
        {
            ...
            //Act
            var actualResult = _commandFactory.Handle("TestUser2 follows TestUser1");
