...
namespace UnitTests
{
    ...
    public class FollowCommandTests
    {
        ...
        public void Setup()
        {
            ...
            {
                new FollowCommand(_mockTwitterUserFeedService.Object, _mockParseCommand.Object)
            };
        ...
        public void ExecutePostCommand_When_Passing_Valid_Post_Command_Returns_True()
        {
            ...
            //Act
            var actualResult = _commandFactory.HandleCommand("TestUser2 follows TestUser1");
